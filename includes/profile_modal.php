            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="curr_password" name="curr_password" placeholder="Please input your password to save changes!" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_delete.php">
                <input type="hidden" class="userid" name="id">
                <div class="text-center">
                    <p>ARE YOU SURE DELETE YOUR ACCOUNT!</p>
